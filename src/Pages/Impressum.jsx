...
class Impressum extends React.Component {
    render() {
        ...
        <div className="container">
          ...
          <a href="http://stefanwehrmeyer.com/">Stefan Wehrmeyer</a>, Andrej Sandorf</dd>
          </dl>
          <dl>
          <dt>Technik:</dt>
          <dd>
          ...
          Vorschriften gelöscht, sofern Sie nicht ausdrücklich in die weitere Nutzung Ihrer Daten eingewilligt haben.</p>
          ...
          sofern dies zur Erbringung unserer Dienstleistung oder zur Vertragsdurchführung notwendig ist und Sie ausdrücklich eingewilligt haben.</p>
