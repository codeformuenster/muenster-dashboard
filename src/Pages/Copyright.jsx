...
class Copyright extends React.Component {
    render() {
        ...
        for (let info of infos) {
            ...
            rows.push((<div className="box SideColorBox" style={{ background: 'linear-gradient(to right, ' + myColor + ' ,' + myColor + ' 20px,#fff 20px)' }}>
          <p className="title">{info[0]}</p>
          {info[1]}
        </div>));
        }
        return (<section className="section copyrightBg">
