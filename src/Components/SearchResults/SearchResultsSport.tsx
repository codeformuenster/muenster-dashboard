...
class SearchResultsSport extends SearchResults {
        ...
        <div className="media-left">
          <p>
            <span className="icon is-large">
              <i className="mdi mdi-48px mdi-soccer" />
            </span>
          </p>
        ...
        <div className="media-content">
          <div className="content">
            <span className="title">
              ...
              <span className="tag is-dark">Sportstätte</span> &nbsp;
            </span>
...
export default SearchResultsSport;
