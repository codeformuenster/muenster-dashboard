...
class SearchResultsSchool extends SearchResults {
        ...
        <div className="media-left">
          <p>
            <span className="icon is-large">
              <i className="mdi mdi-48px mdi-school" />
            </span>
          </p>
        ...
        <div className="media-content">
          <div className="content">
            <span className="title">
              ...
              <span className="tag is-dark">Schule</span> &nbsp;
            </span>
...
export default SearchResultsSchool;
