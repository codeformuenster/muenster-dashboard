...
class SearchResultsAgency extends SearchResults {
        ...
        <div className="media-left">
          <p>
            <span className="icon is-large">
              <i className="mdi mdi-48px mdi-briefcase" />
            </span>
          </p>
        ...
        <div className="media-content">
          <div className="content">
            <span className="title">
              ...
              <span className="tag is-dark">Amt</span> &nbsp;
            </span>
...
export default SearchResultsAgency;
