    ...
    return (
      <section className="section">
        <div className="container">
          <div className="content">
        	...
        	<dl>
        		...
        		<dd><a href="http://nadinestammen.de/">Nadine Stammen</a>, Felix Becker, <a href="http://stefanwehrmeyer.com/">Stefan Wehrmeyer</a>, Andrej Sandorf</dd>
        	</dl>
        	<dl>
        		<dt>Technik:</dt>
        		<dd>
        ...
        <br />
        	...
        	<p>Die Website <a href="http://www.okfn.de">www.okfn.de</a> nutzt Piwik (<a href="http://www.piwik.org">http://www.piwik.org</a>), einen Open-Source-Webanalysedienst. Piwik verwendet sogenannte “Cookies”, Textdateien, die auf Ihrem
        		...
        		der Datenhoheit von <a href="http://www.okfn.de">www.okfn.de</a>. Wir benutzen diese Informationen, um die Nutzung auszuwerten und um Reports über die Websiteaktivitäten zusammenzustellen. OKF DE wird diese Informationen nicht an
        		...
        		dieser Website voll umfänglich nutzen können. Durch die Nutzung dieser Website erklären Sie sich mit der Bearbeitung der über Sie erhobenen Daten durch <a href="http://www.okfn.de">www.okfn.de</a> in der zuvor beschriebenen Art und
        		Weise und zu dem zuvor benannten Zweck einverstanden.</p>
        	<h3>V. Newsletter</h3>
        	<p>Bei Anmeldung zum E-Mail-Newsletter wird Ihre E-Mailadresse mit Ihrer Einwilligung für eigene Zwecke genutzt, bis Sie sich vom Newsletter abmelden. Eine Abmeldung ist jederzeit über den dafür vorgesehenen Link im Newsletter oder eine
          ...
          bezüglich der Verarbeitung Ihrer personenbezogenen Daten stehen. Auch haben Sie nach dem Bundesdatenschutzgesetz ein Recht auf
            ...
            wenden Sie sich bitte jederzeit an <a href="mailto:info@okfn.de">info@okfn.de</a>.</p>
