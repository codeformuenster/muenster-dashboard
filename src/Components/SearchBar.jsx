...
class SearchBar extends React.Component {
    constructor(props) {
        ...
        this.onDistrictChange = (event) => {
            ...
            if (this.props.districts) {
                ...
                const found = this.props.districts.find((d) => { return d.number === Number(district); });
                if (found) {
    ...
    render() {
        ...
        let districtList = this.props.districts.map((d) => {
            return <option key={d.number} value={d.number}>{d.name}</option>;
        });
        return (<div className="columns notification is-warning">
        <div className="column">
          <div className="field">
          
            <div className="control has-icons-left has-icons-right">
              <DebounceInput className="input is-large" type="text" onChange={this.onSearchTermChange} placeholder="Suchbegriff"/>
        ...
        <div className="column">
          <div className="field">
            <div className="control has-icons-left has-icons-right">
              <div className="select is-large is-fullwidth">
                <select onChange={this.onDistrictChange} value={this.props.searchParams.district}>
