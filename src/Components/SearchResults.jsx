...
class SearchResults extends React.Component {
    ...
    render() {
        ...
        if (searchParams.selectedId) {
            ...
            if (result) {
                return (<SearchResultDetailled result={result} searchParams={this.props.searchParams} updateHandler={this.props.updateHandler}/>);
            }
        }
        ...
        {results.map((result) => {
            ...
            return (<article key={result.id} className={'notification' + ((searchParams.selectedId === result.id) ? ' ' + meinItem.color : '')} onClick={e => this.toggleSelection(e, result.id)}>
