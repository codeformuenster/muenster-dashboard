export const categories = [
  { name: 'Abfalleimer', type: 'papierkorb', searchTerms: [] },
  { name: 'Baustellen', type: 'construction', searchTerms: [] },
  { name: 'Bäder', type: 'pool', searchTerms: [] },
  { name: 'Kitas', type: 'kindergarden', searchTerms: [] },
  ...
  { name: 'WLANs', type: 'wifi', searchTerms: [] },
]
